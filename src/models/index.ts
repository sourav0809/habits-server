...
export type { IUser, CreateUserInput, UpdateUserInput } from "./user.model";

export { default as UserActivityModel } from "./userActivity.model";
export type { IUserActivity } from "./userActivity.model";

export { default as UserFoodModel } from "./userFood.model";
export type { IUserFood, CreateUserFoodInput } from "./userFood.model";
